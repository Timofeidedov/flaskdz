...
cur.execute(
    '''DELETE FROM questions WHERE id>12'''
)
db.commit()
app = Flask(__name__)
...
def stats():
    ...
    if round(all_info['q2_mean'],0)==1:
        ...
        content1='скорее нет'
    elif round(all_info['q2_mean'],0)==3:
        content1='затрудняюсь'
    elif round(all_info['q2_mean'],0)==4:
        content1='скорее да'
    elif round(all_info['q2_mean'],0)==5:
        content1='согласен'
    if round(all_info['q3_mean'],0)==1:
        content2='не согласен'
    elif round(all_info['q3_mean'],0)==2:
        content2='скорее нет'
    elif round(all_info['q3_mean'],0)==3:
        content2='затрудняюсь'
    elif round(all_info['q3_mean'],0)==4:
        content2='скорее да'
    elif round(all_info['q3_mean'],0)==5:
        content2='согласен'
    if round(all_info['q5_mean'],0)==1:
        content3='не согласен'
    elif round(all_info['q5_mean'],0)==2:
        content3='скорее нет'
    elif round(all_info['q5_mean'],0)==3:
        content3='затрудняюсь'
    elif round(all_info['q5_mean'],0)==4:
        content3='скорее да'
    elif round(all_info['q5_mean'],0)==5:
        content3='согласен'
    if round(all_info['q7_mean'],0)==1:
        content4='не согласен'
    elif round(all_info['q7_mean'],0)==2:
        content3='скорее нет'
    elif round(all_info['q7_mean'],0)==3:
        content4='затрудняюсь'
    elif round(all_info['q7_mean'],0)==4:
        content4='скорее да'
    elif round(all_info['q7_mean'],0)==5:
        content4='согласен'
